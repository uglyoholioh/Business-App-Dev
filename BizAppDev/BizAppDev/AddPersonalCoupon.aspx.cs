...
namespace BizAppDev
{
    public partial class AddPersonalCoupon : System.Web.UI.Page
    {
        ...
        protected void btn_insert_Click(object sender, EventArgs e)
        {
            ...
            Coupons2 coup = new Coupons2(kan, tb_name.Text, tb_desc.Text, int.Parse(tb_amount.Text), int.Parse(tb_cost.Text), decimal.Parse(tb_discount.Text), int.Parse(tb_validdays.Text), int.Parse(tb_validmonths.Text), int.Parse(tb_validyears.Text));
