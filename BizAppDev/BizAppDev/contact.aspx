<%@ Page Title="" Language="C#" MasterPageFile="~/nonmembermaster.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="BizAppDev.contact" %>
                      ...
                      <div class="row50">
                        <div class="inputBox">
                              ...
                              <asp:TextBox ID="tb_email" runat="server" placeholder="" Height="32px" Width="376px" required></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Email Address Format"   ForeColor="Red" ValidationExpression="^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$"  Display = "Dynamic" ControlToValidate="tb_email"></asp:RegularExpressionValidator>
                             </div>
                     </div>
                      <div class="row100">
                           <div class="inputBox">
