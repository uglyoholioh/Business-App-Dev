<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMain.Master" AutoEventWireup="true" CodeBehind="package.aspx.cs" Inherits="BizAppDev.package" %>
               ...
               <asp:Image ID="Image1" runat="server" ImageUrl='<%# "/images/" + Eval("package_Image") %>'   Height="300px" />
                    <div class="card-body">
                      <h5 class="card-title">
                        ...
                        <a class="btn btn-primary" href="package_desc.aspx?id=<%#Eval("package_Name")%>">View</a>
