<%@ Page Title="" Language="C#" MasterPageFile="~/staff.Master" AutoEventWireup="true" CodeBehind="Adminlist.aspx.cs" Inherits="BizAppDev.Adminlist" %>
            ...
            <div class="container-fluid" id="div_Membership">
              <div class="row" style="margin-left:20px; ">
                <div class="col-md-6 col-lg-3" >
                    ...
                    <asp:DataList ID="DataList5" runat="server" DataSourceID="SqlDataSource5"  DataKeyField="AdmID" style="width:1000px; margin-left:20px; margin-bottom:50px;" OnDeleteCommand="DataList5_DeleteCommand" OnEditCommand="DataList5_EditCommand">
                        <ItemTemplate>
                           EmpID:
